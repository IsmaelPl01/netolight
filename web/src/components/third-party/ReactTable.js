        ...
        <Stack direction="row" spacing={1} alignItems="center">
          <Stack direction="row" spacing={1} alignItems="center">
            <Typography variant="caption" color="secondary">
              {intl.formatMessage({ id: 'table.pagination.dropdown.row_per_page.label' })}
            </Typography>
            <FormControl sx={{ m: 1 }}>
              <Select
          ...
          <Typography variant="caption" color="secondary">
            {intl.formatMessage({ id: 'table.pagination.dropdown.go_to_page.label' })}
          </Typography>
          <TextField
            size="small"
            type="number"
    ...
    <FormControl sx={{ width: 200 }}>
      <Select
        ...
        renderValue={(selected) => {
          ...
          if (!selected) {
            return <Typography variant="subtitle1">{intl.formatMessage({ id: 'table.sortby.dropdown.label' })}</Typography>;
          }

          return (
            <Typography variant="subtitle2">
              {`${intl.formatMessage({ id: 'table.sortby.dropdown.label' })} (${
